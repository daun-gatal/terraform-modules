...
### Changed
- **hms**: Updated `init_container` to support flexible JAR downloading via `additional_jars` variable.
- **hms**: parameterized `hadoop-aws` and `aws-java-sdk-bundle` versions.
